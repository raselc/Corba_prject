 ...
 */
public class _RMBStub extends org.omg.CORBA.portable.ObjectImpl
        implements RMB
{
    ...
    private final static Class _opsClass = RMB_idl.RMBOperations.class;
    ...
    public boolean createCRecord(String firstName, String lastName, String description, String status, String badgeId)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                RMB_idl.RMBOperations _self = (RMB_idl.RMBOperations) _so.servant;
                try
                {
