 ...
 */
public abstract class RMBPOA extends org.omg.PortableServer.Servant
        implements RMBOperations, org.omg.CORBA.portable.InvokeHandler
{
    public RMB _this()
    {
        return RMBHelper.narrow(_this_object());
    }

    public RMB _this(org.omg.CORBA.ORB orb)
    {
        return RMBHelper.narrow(_this_object(orb));
    }
