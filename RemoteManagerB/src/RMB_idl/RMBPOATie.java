 ...
 */
public class RMBPOATie extends RMBPOA
{

    //
    // Private reference to implementation object
    //
    private RMBOperations _tie;
     ...
     * Constructor
     */
    public RMBPOATie(RMBOperations tieObject)
    {
        _tie = tieObject;
    }
     ...
     * Constructor
     */
    public RMBPOATie(RMBOperations tieObject, org.omg.PortableServer.POA poa)
    {
        _tie = tieObject;
        _poa = poa;
    }
     ...
     * Get the delegate
     */
    public RMBOperations _delegate()
    {
        return _tie;
    }
     ...
     * Set the delegate
     */
    public void _delegate(RMBOperations delegate_)
    {
        _tie = delegate_;
    }
