 ...
 */
public abstract class RMAPOA extends org.omg.PortableServer.Servant
        implements RMAOperations, org.omg.CORBA.portable.InvokeHandler
{
    public RMA _this()
    {
        return RMAHelper.narrow(_this_object());
    }

    public RMA _this(org.omg.CORBA.ORB orb)
    {
        return RMAHelper.narrow(_this_object(orb));
    }
